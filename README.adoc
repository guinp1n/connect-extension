...
This Hello Connect extension registers a PublishInboundInterceptor to modify the Keep Alive of every CONNECT with the value of 66 seconds.
...
You should see that the Keep Alive of the client is 66 seconds.
